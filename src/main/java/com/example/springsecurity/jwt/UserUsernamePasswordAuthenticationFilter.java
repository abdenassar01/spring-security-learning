...
public class UserUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        String token = Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor("supersucretkeythatnoonecangesssupersucretkeythatnoonecangesssupersucretkeythatnoonecangesssupersucretkeythatnoonecangess".getBytes()))
                .compact();
